<template>
  <main>
        ...
        <div class="main__presentation__elem">
          ...
          <div class="main__presentation__elem__media">
            <transition name="fade" mode="out-in">
              ...
              >
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/ankiety-35c4d.appspot.com/o/mysl.jpg?alt=media&token=7e4637c9-e34e-4a1b-ab8b-5957d64cc02a"
                  alt
                >
              </div>
              ...
              >
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/ankiety-35c4d.appspot.com/o/mysl1.jpg?alt=media&token=4b3d4ae6-7286-4d27-8cee-398db6c3dedc"
                  alt
                >
              </div>
              ...
              >
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/ankiety-35c4d.appspot.com/o/mysl2.jpg?alt=media&token=ed67861e-825f-4b9a-8a00-a4f69d837459"
                  alt
                >
              </div>
              <div
              ...
              >
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/ankiety-35c4d.appspot.com/o/mysl3.jpg?alt=media&token=7627d870-1934-4215-8bdd-79b2226ba49c"
                  alt
                >
              </div>
            </transition>
    ...
    <transition name="fadeslow">
      <button v-if="info.survey && textThoughtClicked" @click="goToSurvey">Start</button>
    </transition>
  </main>
</template>
